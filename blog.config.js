...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dzing', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Dzingの摸🐟生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cuter.fun', // 网站地址
